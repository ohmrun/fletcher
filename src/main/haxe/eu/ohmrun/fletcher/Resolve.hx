...
typedef ResolveDef<I,E> = FletcherDef<Exception<E>,Chunk<I,E>,Noise>;
...
abstract Resolve<I,E>(ResolveDef<I,E>) from ResolveDef<I,E> to ResolveDef<I,E>{
  ...
  @:from static public function fromResolvePropose<I,E>(self:Fletcher<Exception<E>,Propose<I,E>,Noise>):Resolve<I,E>{
    return lift(
      self.then(
  ...
  @:from static public function fromFunErrPropose<I,E>(arw:Exception<E>->Propose<I,E>):Resolve<I,E>{
    return lift(
      Fletcher.Then(
        Fletcher.Sync(arw),
  ...
  @:from static public function fromErrChunk<I,E>(fn:Exception<E>->Chunk<I,E>):Resolve<I,E>{
    return lift(Fletcher.Sync(fn));
  }
  @:noUsing static public function unit<I,E>():Resolve<I,E>{
    return lift(Fletcher.Sync((e:Exception<E>) -> Tap));
  }
  ...
  @:to public inline function toFletcher():Fletcher<Exception<E>,Chunk<I,E>,Noise>{
    return this;
  }
}
class ResolveLift{
