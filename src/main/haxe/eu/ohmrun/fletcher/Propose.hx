...
abstract Propose<O,E>(ProposeDef<O,E>) from ProposeDef<O,E> to ProposeDef<O,E>{
  ...
  @:noUsing static public function fromException<O,E>(e:Exception<E>):Propose<O,E>{
...
class ProposeLift{
  ...
  static public inline function environment<O,E>(self:ProposeDef<O,E>,success:Option<O>->Void,failure:Exception<E>->Void){
